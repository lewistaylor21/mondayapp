...
async function main() {
    try {
        console.log(`🔍 Ready to calculate billing for board ID: ${BOARD_ID}`);
        console.log('📋 This script provides the billing calculation logic.');
        ...
        console.log('   2. Pass the results to processItems() function');
        console.log('   3. Display the results with displayResults() function');
